...
example_dirname = os.path.abspath(os.path.join(os.path.dirname(__file__),'../'))
caffe_dirname = os.path.abspath(os.path.join(example_dirname, '../..'))
training_dirname = os.path.abspath(os.path.join(os.path.dirname(__file__),'../'))
...
if __name__ == '__main__':
    ...
    csv_filename = os.path.join(example_dirname, '/home/sharathc001/caffe-master/examples/finetune_flickr_style/Scripts/psychoflickr_output.csv')
